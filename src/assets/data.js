...
export const pricingPlans = [
  {
    ...
    price: "₹0",
    period: "forever",
    features: ["10 File Uploads","10 Credits", "Basic sharing", "Community support"],
  ...
  },
  {
    name: "Premium",
    price: "₹50",
    features: ["500 File Uploads", "500 Credits","Access basic features", "Priority support"],
    buttonText: "Get Pro",
    popular: true,
  },
  {
    name: "Ultimate",
    price: "₹100",
    features: ["5000 File upload", " 5000 Credits","Custom integrations", "Dedicated support", "Advanced security"],
